...
;Main.c,114 :: 		LoadConstantsAndOffsets();
	CALL        _LoadConstantsAndOffsets+0, 0
;Main.c,117 :: 		while(USBDev_GetDeviceState() != _USB_DEV_STATE_CONFIGURED) { }
L_main0:
...
;Main.c,132 :: 		if(dataReceivedFlag)
	...
	BTFSC       STATUS+0, 2 
	GOTO        L_main4
;Main.c,134 :: 		if(readbuff[0] == CMD_SET_CALIBRATION)
	MOVF        1280, 0 
	XORLW       163
	BTFSS       STATUS+0, 2 
	GOTO        L_main5
;Main.c,136 :: 		SaveConstantsAndOffsets();
	CALL        _SaveConstantsAndOffsets+0, 0
;Main.c,137 :: 		LoadConstantsAndOffsets();
	CALL        _LoadConstantsAndOffsets+0, 0
;Main.c,138 :: 		}
L_main5:
;Main.c,139 :: 		dataReceivedFlag = 0;
	CLRF        _dataReceivedFlag+0 
;Main.c,140 :: 		}
L_main4:
;Main.c,143 :: 		buffIndex = 0;
	CLRF        main_buffIndex_L0+0 
;Main.c,144 :: 		for(i = 0; i < 25; i++)
	CLRF        main_i_L0+0 
L_main6:
	MOVLW       25
	SUBWF       main_i_L0+0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_main7
;Main.c,147 :: 		MCP3304_Read(0);
	CLRF        FARG_MCP3304_Read_Channel+0 
	CALL        _MCP3304_Read+0, 0
;Main.c,150 :: 		if(MCP3304_Data & 0x8000)
	BTFSS       _MCP3304_Data+1, 7 
	GOTO        L_main9
;Main.c,152 :: 		AbsValue =  MCP3304_Data * -1;
...
;Main.c,153 :: 		MCP3304_Data = (AbsValue + lastValue) / 2;
...
;Main.c,156 :: 		}
	GOTO        L_main11
L_main9:
;Main.c,159 :: 		AbsValue =  MCP3304_Data;
	MOVF        _MCP3304_Data+0, 0 
	MOVWF       main_AbsValue_L0+0 
	MOVF        _MCP3304_Data+1, 0 
	MOVWF       main_AbsValue_L0+1 
;Main.c,160 :: 		MCP3304_Data = (AbsValue + lastValue) / 2;
	MOVF        main_lastValue_L0+0, 0 
...
;Main.c,166 :: 		writebuff[buffIndex] = Lo(MCP3304_Data);
	...
	MOVF        _MCP3304_Data+0, 0 
	MOVWF       POSTINC1+0 
;Main.c,167 :: 		writebuff[buffIndex + 1] = Hi(MCP3304_Data);
	MOVF        main_buffIndex_L0+0, 0 
	ADDLW       1
	MOVWF       R0 
	CLRF        R1 
...
;Main.c,169 :: 		}
	GOTO        L_main6
L_main7:
;Main.c,172 :: 		MCP3304_Read(2);
	MOVLW       2
	MOVWF       FARG_MCP3304_Read_Channel+0 
	CALL        _MCP3304_Read+0, 0
;Main.c,173 :: 		writebuff[50] = Lo(MCP3304_Data);
	MOVF        _MCP3304_Data+0, 0 
	MOVWF       1394 
;Main.c,174 :: 		writebuff[51] = Hi(MCP3304_Data);
	MOVF        _MCP3304_Data+1, 0 
	MOVWF       1395 
...
;Main.c,183 :: 		while(!UsbDataSentFlag) { }
L_main13:
...
;Main.c,188 :: 		void SaveConstantsAndOffsets()
;Main.c,191 :: 		Lo(Voltage_Constant) = readbuff[1];
	MOVF        1281, 0 
	MOVWF       _Voltage_Constant+0 
;Main.c,192 :: 		Hi(Voltage_Constant) = readbuff[2];
	MOVF        1282, 0 
	MOVWF       _Voltage_Constant+1 
;Main.c,193 :: 		Higher(Voltage_Constant) = readbuff[3];
	MOVF        1283, 0 
	MOVWF       _Voltage_Constant+2 
;Main.c,194 :: 		Highest(Voltage_Constant) = readbuff[4];
	MOVF        1284, 0 
	MOVWF       _Voltage_Constant+3 
;Main.c,195 :: 		ConvertIEEE754FloatToMicrochip(&Voltage_Constant);
...
;Main.c,198 :: 		if(Voltage_Constant != 0)
	...
	MOVF        R0, 1 
	BTFSC       STATUS+0, 2 
	GOTO        L_SaveConstantsAndOffsets15
;Main.c,201 :: 		EEPROM_Write(0, readbuff[1]);                     // Lo(Voltage_Constant)
...
L_SaveConstantsAndOffsets16:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets16
;Main.c,203 :: 		EEPROM_Write(1, readbuff[2]);                     // Hi(Voltage_Constant)
	MOVLW       1
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1282, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
	CALL        _EEPROM_Write+0, 0
;Main.c,204 :: 		Delay_ms(5);
	MOVLW       78
	MOVWF       R12, 0
	MOVLW       235
	MOVWF       R13, 0
L_SaveConstantsAndOffsets17:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets17
;Main.c,205 :: 		EEPROM_Write(2, readbuff[3]);                     // Higher(Voltage_Constant)
	MOVLW       2
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1283, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets18:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets18
;Main.c,207 :: 		EEPROM_Write(3, readbuff[4]);                     // Highest(Voltage_Constant)
	MOVLW       3
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1284, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets19:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets19
;Main.c,211 :: 		EEPROM_Write(4, readbuff[5]);                     // Lo(Voltage_offset)
	MOVLW       4
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1285, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets20:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets20
;Main.c,213 :: 		EEPROM_Write(5, readbuff[6]);                     // Hi(Voltage_offset)
	MOVLW       5
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1286, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
;Main.c,218 :: 		Lo(Current_Constant) = readbuff[7];
	MOVF        1287, 0 
	MOVWF       _Current_Constant+0 
;Main.c,219 :: 		Hi(Current_Constant) = readbuff[8];
	MOVF        1288, 0 
	MOVWF       _Current_Constant+1 
;Main.c,220 :: 		Higher(Current_Constant) = readbuff[9];
	MOVF        1289, 0 
	MOVWF       _Current_Constant+2 
;Main.c,221 :: 		Highest(Current_Constant) = readbuff[10];
	MOVF        1290, 0 
	MOVWF       _Current_Constant+3 
;Main.c,222 :: 		ConvertIEEE754FloatToMicrochip(&Current_Constant);
	MOVLW       _Current_Constant+0
	MOVWF       FARG_ConvertIEEE754FloatToMicrochip_f+0 
	MOVLW       hi_addr(_Current_Constant+0)
	MOVWF       FARG_ConvertIEEE754FloatToMicrochip_f+1 
	CALL        _ConvertIEEE754FloatToMicrochip+0, 0
;Main.c,225 :: 		if(Current_Constant != 0)
	...
	MOVF        R0, 1 
	BTFSC       STATUS+0, 2 
	GOTO        L_SaveConstantsAndOffsets22
;Main.c,228 :: 		EEPROM_Write(6, readbuff[7]);                     // Lo(Current_Constant)
	MOVLW       6
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1287, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets23:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets23
;Main.c,230 :: 		EEPROM_Write(7, readbuff[8]);                     // Hi(Current_Constant)
	MOVLW       7
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1288, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets24:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets24
;Main.c,232 :: 		EEPROM_Write(8, readbuff[9]);                     // Higher(Current_Constant)
	MOVLW       8
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1289, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets25:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets25
;Main.c,234 :: 		EEPROM_Write(9, readbuff[10]);                    // Highest(Current_Constant)
	MOVLW       9
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1290, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets26:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets26
;Main.c,238 :: 		EEPROM_Write(10, readbuff[11]);                   // Lo(Current_offset)
	MOVLW       10
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1291, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
L_SaveConstantsAndOffsets27:
	...
	DECFSZ      R12, 1, 1
	BRA         L_SaveConstantsAndOffsets27
;Main.c,240 :: 		EEPROM_Write(11, readbuff[12]);                   // Hi(Current_offset)
	MOVLW       11
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVF        1292, 0 
	MOVWF       FARG_EEPROM_Write_data_+0 
...
;Main.c,246 :: 		void LoadConstantsAndOffsets()
;Main.c,249 :: 		writebuff[52] = EEPROM_Read(0);                     // Lo(Voltage_Constant)
	CLRF        FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1396 
;Main.c,250 :: 		writebuff[53] = EEPROM_Read(1);                     // Hi(Voltage_Constant)
	MOVLW       1
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1397 
;Main.c,251 :: 		writebuff[54] = EEPROM_Read(2);                     // Higher(Voltage_Constant)
	MOVLW       2
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1398 
;Main.c,252 :: 		writebuff[55] = EEPROM_Read(3);                     // Highest(Voltage_Constant)
	MOVLW       3
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1399 
;Main.c,255 :: 		writebuff[56] = EEPROM_Read(4);                     // Lo(Voltage_offset)
	MOVLW       4
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1400 
;Main.c,256 :: 		writebuff[57] = EEPROM_Read(5);                     // Hi(Voltage_offset)
	MOVLW       5
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1401 
;Main.c,259 :: 		writebuff[58] = EEPROM_Read(6);                     // Lo(Current_Constant)
	MOVLW       6
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1402 
;Main.c,260 :: 		writebuff[59] = EEPROM_Read(7);                     // Hi(Current_Constant)
	MOVLW       7
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1403 
;Main.c,261 :: 		writebuff[60] = EEPROM_Read(8);                     // Higher(Current_Constant)
	MOVLW       8
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1404 
;Main.c,262 :: 		writebuff[61] = EEPROM_Read(9);                     // Highest(Current_Constant)
	MOVLW       9
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1405 
;Main.c,265 :: 		writebuff[62] = EEPROM_Read(10);                    // Lo(Current_offset)
	MOVLW       10
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
	MOVWF       1406 
;Main.c,266 :: 		writebuff[63] = EEPROM_Read(11);                    // Hi(Current_offset)
	MOVLW       11
	MOVWF       FARG_EEPROM_Read_address+0 
	CALL        _EEPROM_Read+0, 0
	MOVF        R0, 0 
...
;Main.c,270 :: 		void USBDev_EventHandler(uint8_t event)
;Main.c,272 :: 		switch(event)
	GOTO        L_USBDev_EventHandler29
;Main.c,275 :: 		case _USB_DEV_EVENT_CONFIGURED:
L_USBDev_EventHandler31:
;Main.c,277 :: 		USBDev_SetReceiveBuffer(1, readbuff);
	MOVLW       1
...
;Main.c,283 :: 		void USBDev_DataReceivedHandler(uint8_t ep, uint16_t size)
;Main.c,285 :: 		if(ep == 1)
	MOVF        FARG_USBDev_DataReceivedHandler_ep+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_USBDev_DataReceivedHandler32
;Main.c,287 :: 		dataReceivedFlag = 1;
	MOVLW       1
	MOVWF       _dataReceivedFlag+0 
;Main.c,288 :: 		}
L_USBDev_DataReceivedHandler32:
;Main.c,289 :: 		}
...
;Main.c,292 :: 		void USBDev_DataSentHandler(uint8_t ep)
;Main.c,294 :: 		if(ep == 1)
	MOVF        FARG_USBDev_DataSentHandler_ep+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_USBDev_DataSentHandler33
;Main.c,296 :: 		UsbDataSentFlag = 1;
	MOVLW       1
	MOVWF       _UsbDataSentFlag+0 
;Main.c,298 :: 		USBDev_SetReceiveBuffer(1, readbuff);
	MOVLW       1
	MOVWF       FARG_USBDev_SetReceiveBuffer_epNum+0 
	MOVLW       _readbuff+0
	MOVWF       FARG_USBDev_SetReceiveBuffer_dataBuffer+0 
